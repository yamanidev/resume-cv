## About
This repository contains my [resume](./Mohamed_Yamani_resume.pdf) generated by the [RenderCV](https://docs.rendercv.com/) engine which uses YAML source files to generate output in various formats including PDF, Markdown, HTML, PNG and LaTeX.
